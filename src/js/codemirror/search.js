        ...
        const searchWidgetTemplate = [
            '<div class="cm-search-widget-template" style="display:none;">',
              '<div class="cm-search-widget">',
                '<span class="cm-maximize" title="Maximize"><svg viewBox="0 0 40 40"><path d="M4,16V4h12M24,4H36V16M4,24V36H16M36,24V36H24" /><path d="M14 2.5v12h-12M38 14h-12v-12M14 38v-12h-12M26 38v-12h12" /></svg><span class="iconCaption">Maximize</span></span>&ensp;',
                '<span class="cm-search-widget-input">',
                    '<span class="searchfield">',
                        '<input type="search" spellcheck="false" placeholder="">',
                        '<span class="fa-icon" title="Search">search<span class="iconCaption">Search</span></span>',
                    '</span>&ensp;',
                  '<span class="cm-search-widget-up cm-search-widget-button fa-icon" title="Previous match">angle-up<span class="iconCaption">Prev</span></span>&nbsp;',
                  '<span class="cm-search-widget-down cm-search-widget-button fa-icon fa-icon-vflipped" title="Next match">angle-up<span class="iconCaption">Next</span></span>&ensp;',
                  '<span class="cm-search-widget-count"></span>',
                '</span>',
                '<span class="cm-linter-widget" data-lint="0">',
                  '<span class="cm-linter-widget-count"></span>&ensp;',
                  '<span class="cm-linter-widget-up cm-search-widget-button fa-icon" title="Previous problem">angle-up<span class="iconCaption">Prev issue</span></span>&nbsp;',
                  '<span class="cm-linter-widget-down cm-search-widget-button fa-icon fa-icon-vflipped" title="Next problem">angle-up<span class="iconCaption">Next issue</span></span>&ensp;',
                '</span>',
                '<span>',
                    '<a class="fa-icon sourceURL" href title="Open source URL">external-link<span class="iconCaption">Source</span></a>',
                '</span>',
              '</div>',
            '</div>',
        ].join('\n');
